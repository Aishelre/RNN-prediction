...
class Prediction():
    ...
    def start(self):
        ...
        for file in self.csv_file:
            with open(self.ckpt_dir+"/Hyper parameters.txt", 'rt') as fp:
            ...
            self.hidden_dim = param['hdn_dim']
            self.output_dim = param['out_dim']
    ...
    def predict(self, filename):
        ...
        print("------------------------")
        with open(self.ckpt_dir+"/"+str(precision_2)+".txt", 'wt') as fp:
